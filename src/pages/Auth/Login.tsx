  ...
  return (
    <div className="h-full flex flex-col bg-[#16180a] text-white overflow-hidden relative">
      ...
      <div className="flex-1 px-8 pt-8 flex flex-col justify-center pb-12">
        <div className="mb-10">
          <h1 className="text-[32px] font-medium leading-[1.1] tracking-tight mb-2">Welcome<br/>Back</h1>
          <p className="text-white/60 text-sm">Log in to continue your focus journey</p>
        </div>
