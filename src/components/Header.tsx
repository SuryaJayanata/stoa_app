  ...
  return (
    <div className="flex justify-between items-center px-6 py-4 mb-2">
      ...
      <button 
        ...
        className="w-11 h-11 bg-surface border border-border-color shadow-sm rounded-full flex justify-center items-center relative text-text-primary hover:bg-surface-hover transition-colors"
      >
